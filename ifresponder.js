...
const ScrollResponderMixin = {
  ...
  scrollResponderHandleStartShouldSetResponder: function(e){
    const currentlyFocusedTextInput = null;// TextInputState.currentlyFocusedField();
   ...
   * @param {SyntheticEvent} e Event.
   */
  scrollResponderHandleTouchCancel: function(e) {
...
const IFScrollResponder = {
  Mixin: ScrollResponderMixin,
};

module.exports = IFScrollResponder;
